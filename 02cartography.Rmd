...
# latest incidence
kreiseWithCovidMeldeWeeklyCleaned$current_incidence <- kreiseWithCovidMeldeWeeklyCleaned$casesWeek_2021_10_06 /kreiseWithCovidMeldeWeeklyCleaned$EWZ * 10 ^5
...
```{r droling cartogram, echo=T, out.width="100%"}
...
Below an example of incidence rate and X.



```{r bivariate,  out.width="100%"}
source("bivariate_maps.R")

kreiseWithCovidMeldeWeeklyCleaned$area <- as.numeric(st_area(kreiseWithCovidMeldeWeeklyCleaned$geometry)/1000000)
...
create_bivar_map(
  crs_prj =25832,
  dataset = kreiseWithCovidMeldeWeeklyCleaned,
  x = "area",
  y = "EWZ",
  x_label = "Area",
  y_label = "Incidence",
  col.rmp = pals::stevens.pinkgreen(9),
